...
<style>
    ...
    #quizzes-table.dataTable thead th.dt-orderable-desc:hover { color: #001330; }
    ...
    #quizzes-table tbody tr:hover { background: rgba(0, 19, 48, 0.035); }
    .dark #quizzes-table tbody tr:hover { background: rgba(0, 19, 48, 0.12); }
