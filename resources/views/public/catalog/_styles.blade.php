...
<style>
        ...
        /* Custom ambient glow */ .ambient-glow::before { content: ''; position: absolute; top: -20%; left: -20%; width: 140%; height: 140%; background: radial-gradient(circle, rgba(70, 72, 212, 0.08) 0%, rgba(255, 255, 255, 0) 70%); z-index: -1; pointer-events: none; }
        .glass-shadow { box-shadow: 0 10px 15px -3px rgba(70, 72, 212, 0.05); }
        .mcq-option-hover:hover { background-color: var(--color-surface-container-low); border-color: var(--color-primary-fixed); box-shadow: 0 4px 6px -1px rgba(70, 72, 212, 0.05); transform: translateY(-2px); }
        ...
        .text-gradient { background: linear-gradient(135deg, #2c2abc 0%, #4648d4 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; }
