...
@endif
<span class="font-label-md text-label-md bg-primary text-on-primary px-6 py-2.5 rounded-full group-hover:bg-primary-container transition-colors shadow-md whitespace-nowrap">Open Paper</span>
</div>
</article>
</a>
@empty
