...
@section('content')
    ...
    {{-- Filters & Action Row --}}
    <div class="glass-panel bg-surface-container-lowest/70 dark:bg-slate-800 rounded-2xl p-5 mb-6 border border-outline-variant/30 dark:border-slate-700 shadow-sm">
        <form action="{{ route('questions') }}" method="GET">
            ...
            <div class="mt-4 flex items-center justify-between gap-3 flex-wrap">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('questions.create') }}" class="flex items-center gap-2 bg-gradient-to-r from-primary to-primary-container text-on-primary px-6 py-2 rounded-full text-sm font-semibold shadow-md hover:shadow-lg transition-all">
                        ...
                        <tr class="hover:bg-primary/5 transition-colors group">
                            ...
                            <td class="py-4 px-6 text-right whitespace-nowrap">
                                <div class="flex justify-end gap-2">
                                    <button class="w-8 h-8 flex items-center justify-center rounded-lg text-on-surface-variant hover:text-primary hover:bg-primary/10 transition-colors" title="Edit">
                                        <i class="fa-solid fa-pen text-sm"></i>
                                    </button>
                                    <button class="w-8 h-8 flex items-center justify-center rounded-lg text-on-surface-variant hover:text-error hover:bg-error/10 transition-colors" title="Delete">
