...
<style>
    ...
    #questions-table.dataTable thead th.dt-orderable-desc:hover { color: #001330; }
    ...
    #questions-table tbody tr:hover { background: rgba(0, 19, 48, 0.035); }
    .dark #questions-table tbody tr:hover { background: rgba(0, 19, 48, 0.12); }
