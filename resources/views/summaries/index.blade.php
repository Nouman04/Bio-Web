...
<style>
    ...
    #summaries-table.dataTable thead th.dt-orderable-desc:hover { color: #4648d4; }
    ...
    #summaries-table tbody tr:hover { background: rgba(70, 72, 212, 0.035); }
    .dark #summaries-table tbody tr:hover { background: rgba(70, 72, 212, 0.12); }
