...
<style>
    ...
    #topics-table.dataTable thead th.dt-orderable-desc:hover { color: #001330; }
    ...
    #topics-table tbody tr:hover { background: rgba(0, 19, 48, 0.035); }
    .dark #topics-table tbody tr:hover { background: rgba(0, 19, 48, 0.12); }
