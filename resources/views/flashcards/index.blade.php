...
<style>
    ...
    #flashcards-table.dataTable thead th.dt-orderable-desc:hover { color: #001330; }
    ...
    #flashcards-table tbody tr:hover { background: rgba(0, 19, 48, 0.035); }
    .dark #flashcards-table tbody tr:hover { background: rgba(0, 19, 48, 0.12); }
