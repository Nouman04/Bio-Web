...
<style>
    ...
    #notes-table.dataTable thead th.dt-orderable-desc:hover { color: #001330; }
    ...
    #notes-table tbody tr:hover { background: rgba(0, 19, 48, 0.035); }
    .dark #notes-table tbody tr:hover { background: rgba(0, 19, 48, 0.12); }
