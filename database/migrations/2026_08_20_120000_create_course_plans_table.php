...
return new class extends Migration
{
     ...
     * the course itself so a course carries no billing columns.
     *
     * One row per billing interval, so a course can be sold monthly and yearly
     * side by side. `price` is in the smallest currency unit, the way Stripe
